...
<div class="order-confirmed__hero">
    <div class="order-confirmed__check">
...
<div class="confirmed-cols">
    ...
    <div class="summary-card">
        ...
        <div class="summary-row">
            <span class="summary-row__key">Amount</span>
...
<div class="order-confirmed__actions">
    <a href="/orders.php" class="btn-checkout">View My Orders</a>
