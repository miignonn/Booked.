...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    if (empty($email) || empty($password)) {
        ...
        $active_tab = 'login';
    } elseif (!str_ends_with($email, '.ac.za')) {
        $error = "Only student emails ending in .ac.za are accepted.";
        $active_tab = 'login';
    } else {
...
<div class="row justify-content-center mt-5">
    <div class="col-md-5 col-lg-4">
        ...
        <!-- LOGIN FORM -->
        <div id="login-form" <?= $active_tab === 'login' ? '' : 'd-none' ?>>
            <form method="POST">
                <div class="mb-3">
        ...
        <!-- REGISTER FORM -->
        <div id="register-form" <?= $active_tab === 'register' ? '' : 'd-none' ?>>
            <form method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="student_number" class="form-control" placeholder="e.g. 12345678">
                </div>
                <div class="mb-3">
                    <label class="form-label">Institution</label>
                    <input type="text" name="institution" class="form-control" placeholder="e.g. University of Pretoria">
                </div>
                <div class="mb-3">
                    <label class="form-label">Phone Number</label>
                    <input type="text" name="phone" class="form-control" placeholder="e.g. 0821234567">
                </div>
                <div class="mb-3">
